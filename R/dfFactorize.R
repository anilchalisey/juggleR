#' @title Factorize data.frame
#'
#' @description Convert character columns in a data.frame to factors.
#'
#' @details Given a data.frame, convert character columns to factors.  By default,
