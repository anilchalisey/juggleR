#' @title Move columns to front/back
#'
#' @description Move specific columns in data.frames to be the first or last columns.
#'
#' @details
...
#' @importFrom dplyr is.tbl select_ one_of tbl_df
#' @importFrom magrittr %>%
